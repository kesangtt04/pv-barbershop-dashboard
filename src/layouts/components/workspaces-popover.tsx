...
export function WorkspacesPopover({ data = [], sx, ...other }: WorkspacesPopoverProps) {
  ...
  const renderLabel = (role: string) => {
    let labelColor: 'warning' | 'info' | 'success' | 'error' = 'warning';
    ...
    return <Label color={labelColor}>{role}</Label>;
  };
